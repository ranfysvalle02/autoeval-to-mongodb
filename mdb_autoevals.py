...
# import Azure OpenAI client library
    ...
    def generate_qa_from_context(self, context_str: str, max_questions: int = 5):  
        ...
        """  
            ...
            response = self.azure_client.chat.completions.create(  
                model="gpt-4o-mini",  # Replace with your Azure OpenAI deployment name  
                messages=[  
            ...
            parsed_json = parsed_json.get('result', parsed_json)  # Handle the case where 'result' is not used
